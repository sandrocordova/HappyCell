...
class Cliente(models.Model):
    CLIE_CODIGO	= models.PositiveIntegerField(db_column='USUA_LOGIN', primary_key = True)	
    NACI_CODIGO	= models.PositiveIntegerField(db_column='USUA_LOGIN')
    TICL_CODIGO	= models.CharField(db_column='USUA_LOGIN', max_length = 2)
    TIDO_CODIGO	= models.CharField(db_column='USUA_LOGIN', max_length = 2)
    ACTI_CODIGO	= models.PositiveIntegerField(db_column='USUA_LOGIN')
    ASES_CODIGO	= models.PositiveIntegerField(db_column='USUA_LOGIN')
    CLIE_IDENTIFICACION	= models.CharField(db_column='USUA_LOGIN', max_length =	20)
    CLIE_NOMBRE	= models.CharField(db_column='USUA_LOGIN', max_length =	60)
    CLIE_FECHA_CREACION	= models.DateTimeField(db_column='USUA_LOGIN')	
    CLIE_NOMBRE_CORRESPONDENCIA	= models.CharField(db_column='USUA_LOGIN', max_length =	40)
    clie_estado	= models.CharField(db_column='USUA_LOGIN', max_length =	1)
    TISB_CODIGO	= models.PositiveIntegerField(db_column='USUA_LOGIN')	
    clie_tipo = models.CharField(db_column='USUA_LOGIN', max_length = 1)
    CLIE_CLAVE = models.CharField(db_column='USUA_LOGIN', max_length = 20)
    CLIE_TIPO_ROL = models.CharField(db_column='USUA_LOGIN', max_length = 2)
    CLIE_TIPO_PROYECTO = models.PositiveIntegerField(db_column='USUA_LOGIN')	
    comodin	= models.PositiveIntegerField(db_column='USUA_LOGIN')	
    ASES = models.PositiveIntegerField(db_column='USUA_LOGIN')	
    CLIE_FECHA_INACTIVACION	= models.DateTimeField(db_column='USUA_LOGIN')	
    CLIE_FECHA_DESAFILIACION = models.DateTimeField(db_column='USUA_LOGIN')	
    sect_codigo	= models.CharField(db_column='USUA_LOGIN', max_length =	5)
    pais_codigo	= models.CharField(db_column='USUA_LOGIN', max_length =	3)
    prov_codigo	= models.CharField(db_column='USUA_LOGIN', max_length =	3)
    cant_codigo	= models.CharField(db_column='USUA_LOGIN', max_length =	5)
    parr_codigo	= models.CharField(db_column='USUA_LOGIN', max_length =	5)
