...
class Usernavdos(models.Model):
    usua_login = models.CharField(db_column='USUA_LOGIN', primary_key=True, max_length=200)  # Field name made lowercase.
    ...
    vent_codigo = models.CharField(db_column='VENT_CODIGO', max_length=200)  # Field name made lowercase.
