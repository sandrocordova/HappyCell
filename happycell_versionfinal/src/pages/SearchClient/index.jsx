...
import { searchClient, searchClientDetail } from "../../Api/apicall_search";
  ...
  const redirectPage = async () => {
    try {
      if (selectedData.length === 0) {
        ...
        const res = await searchClientDetail(
          selectedData[0].TICL_CODIGO,
          selectedData[0].CLIE_CODIGO
        );
        const clientRedux = { cliente: selectedData[0], detalle: res?.cliente };
        dispatch(addClient(clientRedux));
          ...
          <Card>
            <CardHeader>
              <Row>
                ...
                <Col md={2}>
                  <Button className="info" onClick={postSearch}>
                    Buscar
                  </Button>
                </Col>
              </Row>
