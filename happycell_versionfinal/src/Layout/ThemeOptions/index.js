...
} from '../../features/themeOptions/themeOptions';
...
const ThemeOptions = () => {
    ...
    const toggleEnableBackgroundImage = () => {
        dispatch(setEnableBackgroundImage(!enableBackgroundImage))
    }

    const toggleEnableFixedHeader = () => {
        dispatch(setEnableFixedHeader(!enableFixedHeader))
    }

    const toggleEnableHeaderShadow = () => {
        dispatch(setEnableHeaderShadow(!enableHeaderShadow))
    }

    const toggleEnableSidebarShadow = () => {
        dispatch(setEnableSidebarShadow(!enableSidebarShadow))
    }

    const toggleEnableFixedSidebar = () => {
        dispatch(setEnableFixedSidebar(!enableFixedSidebar))
    }

    const toggleEnablePageTitleIcon = () => {
        dispatch(setEnablePageTitleIcon(!enablePageTitleIcon))
    }

    const toggleEnablePageTitleSubheading = () => {
        dispatch(setEnablePageTitleSubheading(!enablePageTitleSubheading));
    }

    const toggleEnablePageTabsAlt = () => {
        dispatch(setEnablePageTabsAlt(!enablePageTabsAlt));
    }

    const toggleEnableFixedFooter = () => {
        dispatch(setEnableFixedFooter(!enableFixedFooter));
    }
                    ...
                    <div className="theme-settings__options-wrapper">
                        ...
                        <h3 className="themeoptions-heading">
                            ...
                            <Button size="sm" color="focus"
                                ...
                                onClick={() => dispatch(setHeaderBackgroundColor(""))}>
                                Restore Default
                            </Button>
                        </h3>
                        <div className="p-3">
                        ...
                        <h3 className="themeoptions-heading">
                            ...
                            <Button size="sm" color="focus"
                                ...
                                onClick={() => dispatch(setBackgroundColor(""))}>
                                Restore Default
                            </Button>
                        </h3>
                        <div className="p-3">
                            <ListGroup>
                                ...
                                <ListGroupItem
                                    ...
                                    <div className={cx("swatch-holder swatch-holder-img", { active: backgroundImage === sideBar6 })}>
                                        <button className="img-holder switch-trigger" onClick={() => dispatch(setBackgroundImage(sideBar6))}>
                                            <img alt=" " src={sideBar6} />
                                        </button>
                                    </div>
                                    <div className={cx("swatch-holder swatch-holder-img", { active: backgroundImage === sideBar7 })}>
                                        <button className="img-holder switch-trigger" onClick={() => dispatch(setBackgroundImage(sideBar7))}>
                        ...
                        <h3 className="themeoptions-heading">
                            ...
                            <Button size="sm" color="focus"
                                ...
                                onClick={() => dispatch(setColorScheme("white"))}>
                                Restore Default
                            </Button>
                        </h3>
                        <div className="p-3">
                                    ...
                                    <div className="theme-settings-swatches">
                                        <ButtonGroup className="mt-2">
                                            <Button className={cx("btn-wide btn-shadow btn-primary", { active: colorScheme === 'white' })}
                                                onClick={() => dispatch(setColorScheme("white"))}>White Theme
                                            </Button>
                                            <Button className={cx("btn-wide btn-shadow btn-primary", { active: colorScheme === 'gray' })}
                                                onClick={() => dispatch(setColorScheme("gray"))}>Gray Theme
                                            </Button>
                                        </ButtonGroup>
                                    </div>
                                </ListGroupItem>
